      ...
      <div className="container mx-auto px-4 z-10 animate-fade-in">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A Full-Stack Software Engineer and Prompt Engineer blending
            creativity, logic, and AI precision.
          </p>

          <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
            I design and automate conversational systems that don't just respond
            — they connect. From smart chatbots that sell and support, to AI
            copy systems that write like humans (only faster), my work lives at
            the intersection of storytelling and engineering.
          </p>
