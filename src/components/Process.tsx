...
const steps = [
  {
    ...
    description:
      "Identify the workflow, bottlenecks, and what needs to be improved or automated.",
  },
  {
    icon: Lightbulb,
    title: "Design the System",
    description:
      "Plan how AI, APIs, and automation will work together to solve the problem.",
  },
  {
    icon: Code,
    title: "Build & Integrate",
    description:
      "Develop the solution and connect it with existing tools and workflows.",
  },
  {
    icon: CheckCircle,
    title: "Test & Optimize",
    description:
      "Refine performance, improve outputs, and ensure the system works reliably in real use.",
  },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            My <span className="text-primary">Approach</span> to Building AI
            Systems
          </h2>
          <p className="text-muted-foreground text-lg">
            A structured approach to designing AI, automation, and scalable
            software systems
          </p>
        </div>
